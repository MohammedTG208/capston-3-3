...
private final CategoryRepository categoryRepository;
    ...
    public void addConsultant(ConsultantDTO consultantDTO) {
        ...
        if (category==null){
            ...
            Consultant consultant=new Consultant(null,consultantDTO.getAcademic_specialization(),consultantDTO.getProfessional_certifications(),consultantDTO.getProfile_summary(),consultantDTO.getExperience_years(), consultantDTO.isStatus(), category,null,null);
