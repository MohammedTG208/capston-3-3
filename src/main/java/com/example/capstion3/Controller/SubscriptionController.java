...
//    @GetMapping("/get/{subscription_type}")
//    public ResponseEntity searchSubscription(@PathVariable String subscription_type) {
//        List<Subscription> subscriptions = subscriptionService.searchSubscription(subscription_type);
